...
\begin{notation}
Furthermore, as an artefact of our particular choice of basis 
for the cohomology space $\HdR^n(\mathfrak{U}/\mathfrak{S})$ 
...
$\mathbf{Q}_q\langle t, r(t)^{-1}\rangle^{\dagger}$ defined as follows:
