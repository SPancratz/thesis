...
the action of $p^{-1} F_p$ on $\Hrig^n(U) \cong \HdR^n(\mathfrak{U})$ 
...
the action of $p^{-1} F_p$ on $\HdR^{n}(\mathfrak{U})$ using our 
previous results.
...
$\dim \HdR^{n}(\mathfrak{U})$ times, where this dimension 
is $\mathcal{O}(d^n)$.
...
action of $p^{-1} F_p$ on $\HdR^{n}(\mathfrak{U})$ in time 
complexity 
\begin{equation*}
