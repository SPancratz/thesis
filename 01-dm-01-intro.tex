...
Problem~\ref{prob:dm-pointcounting}.  

More sophisticated algorithms have been developed.  In the following, we 
only mention a few different approaches and refer the reader to a survey 
by Chambert-Loir~\citep{ChambertLoir2008}.

[[TODO:  Briefly mention $l$-adic algorithmic, canonical lift algorithms, 
and $p$-adic algorithms.  Provide some more detail of Lauder's deformation 
method, provide references for Walker, Hubrechts, and Tuitman.]]
